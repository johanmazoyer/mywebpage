...
\vspace{-0.3cm}
\textbf{Diplôme Ingénieur} -- Space Engineering -- \href{https://www.isae-supaero.fr/en/}{\textbf{\textbf{ISAE Supaero}}} (Toulouse, France) \hfill  { \bf 2011} \\

\vspace{-0.3cm}
\textbf{Diplôme Ingénieur} -- Computer Science -- \href{http://www.polytechnique.edu/en/}{\textbf{\textbf{Ecole polytechnique}}} (Paris, France) \hfill    { \bf 2010 }\\
...
\begin{itemize} \itemsep -2pt
    \item \textbf{Lucie Leboulleux}, now PostDoc in Paris Observatory. 
    \item \textbf{Kevin Fogarty}, now Caltech Prize Postdoctoral Fellow in Experimental Astrophysics.
...
\vspace{-0.8cm}
\textcolor{RoyalBlue}{\section{SELECTED PUBLICATIONS (~60 TOTAL, 7 in first author)}
\vspace{-0.25cm}\hrule}
\vspace{0.6cm}
\begin{enumerate}\itemsep 0pt

\item Chen, C. ; {\bf Mazoyer, J.} ; Poteet, C. A., Ren, B. et al. ({\bf2020}), {\it Multi-Band GPI Imaging of the HR 4796A Debris Disk}, The Astrophysical Journal (Accepted, In press)
